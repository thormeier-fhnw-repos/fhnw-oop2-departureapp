...
public class SplitFlapBuilder<B extends SplitFlapBuilder<B>> {
    ...
    public final B flipTime(final double FLIP_TIME) {
        properties.put("flipTime", new SimpleDoubleProperty(FLIP_TIME));
        return (B)this;
    }

    public final B textColor(final Color TEXT_COLOR) {
    ...
    public final B selection(final String[] SELECTION) {
        properties.put("selection", new SimpleObjectProperty<>(SELECTION));
        return (B)this;
    }
    
    public final B backgroundImage(final Image BACKGROUND_IMAGE) {
        properties.put("backgroundImage", new SimpleObjectProperty<>(BACKGROUND_IMAGE));
        return (B)this;
    }
    
    public final B flapImage(final Image FLAP_IMAGE) {
        properties.put("flapImage", new SimpleObjectProperty<>(FLAP_IMAGE));
        return (B)this;
    }
    ...
    public final SplitFlap build() {
        ...
        for (String key : properties.keySet()) {
            if ("flipTime".equals(key)) {
                ...
                CONTROL.setBackgroundImage(((ObjectProperty<Image>) properties.get(key)).get());
            } else if("flapImage".equals(key)) {
                CONTROL.setFlapImage(((ObjectProperty<Image>) properties.get(key)).get());
