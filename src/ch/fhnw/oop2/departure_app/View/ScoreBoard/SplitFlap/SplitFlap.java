...
public class SplitFlap extends Region {
    ...
    private              Image    bkgImg           = new Image(FileHelper.getAbsolutePath("resources/assets/img/background.png"));
    private              Image    flpImg           = new Image(FileHelper.getAbsolutePath("resources/assets/img/flap.png"));
